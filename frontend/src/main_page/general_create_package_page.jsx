            ...
            <div className="card-body">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                  ...
                  <input type="text" className="form-control" id="send_f_name" placeholder="Enter the receiver's first name" value={send_f_name} onChange={(e) => setSendFName(e.target.value)} required />
                </div>
                <div className="form-group">
                  <label htmlFor="send_l_name">Sender's Last Name</label>
                  <input type="text" className="form-control" id="send_l_name" placeholder="Enter the receiver's last name" value={send_l_name} onChange={(e) => setSendLName(e.target.value)} required />
                </div>
                <div className="form-group">
