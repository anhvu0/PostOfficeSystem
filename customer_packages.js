module.exports = function(req, res, connection, customerID){
    ...
    const query = 'SELECT p.packages_id, Fname, Lname, package_status FROM packages AS p JOIN customers AS c ON p.customers_send_id = c.customers_id WHERE c.customers_id = ?';
